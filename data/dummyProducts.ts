...
export const DUMMY_PRODUCTS: Product[] = [
  ...
  // Fashion - Women's Clothing
  {
    ...
    subcategory: 'Women',
    brand: 'Zara',
    image: '/images/products/zara-trench-coat.jpg',
    rating: 4.4,
    reviewCount: 567,
    stockQuantity: 43,
    isOnSale: true,
  ...
  // Home & Garden - Furniture
  {
    ...
    brand: 'IKEA',
    image: '/images/products/ikea-malm-bed.jpg',
    rating: 4.3,
    reviewCount: 892,
    stockQuantity: 34,
    isOnSale: true,
...
export const ADDITIONAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    subcategory: 'Women',
    brand: 'H&M',
    image: '/images/products/hm-basic-tee.jpg',
    rating: 4.3,
    reviewCount: 2341,
    stockQuantity: 189,
  ...
  // More Home & Garden
  {
    ...
    subcategory: 'Decor',
    brand: 'Target',
    image: '/images/products/target-lamp.jpg',
    rating: 4.4,
    reviewCount: 678,
    stockQuantity: 45,
  ...
  // More Sports & Outdoors
  {
    ...
    subcategory: 'Outdoor',
    brand: 'Patagonia',
    image: '/images/products/patagonia-jacket.jpg',
    rating: 4.8,
    reviewCount: 892,
    stockQuantity: 34,
    isFeatured: true,
